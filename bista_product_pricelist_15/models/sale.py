...
class SaleOrderLine(models.Model):
    ...
    def _get_real_price_currency(self, product, rule_id, qty, uom, pricelist_id):
        """Retrieve the price before applying the pricelist(Note: - This method will be called if the discount policy on the pricelist is 'without_discount')
        ...
        if pricelist_item:
            ...
            ppis = self.env['product.pricelist.item'].search([('product_tmpl_id','=',product.id)])
            for ppi in ppis:
