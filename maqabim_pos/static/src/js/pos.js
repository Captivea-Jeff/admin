odoo.define('maqabim_pos.pos_models', function (require) {
    "use strict";
...
// var screens = require('point_of_sale.screens');
    ...
    const CustomOrderWidget = (OrderWidget) => class extends OrderWidget {
        _updateSummary() {
            this.state = useState({ subtotal:0 });
            const without_tax = this.order ? this.order.get_total_without_tax() : 0;
            ...
            this.state.subtotal = this.env.pos.format_currency(without_tax);
            this.render();
        }
    }
